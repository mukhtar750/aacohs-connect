import{c as n,r as p,j as e}from"./app-m22TGuuT.js";import{D as f,c as x,d as g,e as c}from"./dialog-ClLkslXb.js";import{B as a}from"./Logo-uAgxhY1Z.js";const m=n("Monitor",[["rect",{width:"20",height:"14",x:"2",y:"3",rx:"2",key:"48i651"}],["line",{x1:"8",x2:"16",y1:"21",y2:"21",key:"1svkeh"}],["line",{x1:"12",x2:"12",y1:"17",y2:"21",key:"vw1qmm"}]]);const h=n("Smartphone",[["rect",{width:"14",height:"20",x:"5",y:"2",rx:"2",ry:"2",key:"1yt0o3"}],["path",{d:"M12 18h.01",key:"mhygvu"}]]),y={Newsletter:`
    ...
    </div>`},z=({open:r,onOpenChange:d,templateName:i,customHTML:l})=>{const[t,o]=p.useState("desktop"),s=l||y[i]||"<p>No preview available</p>";return e.jsx(f,{open:r,onOpenChange:d,children:e.jsxs(x,{className:"max-w-3xl max-h-[85vh] flex flex-col",children:[e.jsx(g,{children:e.jsxs(c,{className:"flex items-center justify-between pr-6",children:[e.jsxs("span",{children:[i," Template"]}),e.jsxs("div",{className:"flex gap-1",children:[e.jsx(a,{size:"sm",variant:"ghost",onClick:()=>o("desktop"),className:t==="desktop"?"text-primary":"text-muted-foreground",children:e.jsx(m,{className:"w-4 h-4"})}),e.jsx(a,{size:"sm",variant:"ghost",onClick:()=>o("mobile"),className:t==="mobile"?"text-primary":"text-muted-foreground",children:e.jsx(h,{className:"w-4 h-4"})})]})]})}),e.jsx("div",{className:"flex-1 overflow-y-auto bg-muted/50 rounded-lg p-4",children:e.jsx("div",{className:`mx-auto transition-all ${t==="mobile"?"max-w-[375px]":"max-w-[600px]"}`,style:{background:"#f1f5f9",padding:"16px",borderRadius:"8px"},children:e.jsx("div",{dangerouslySetInnerHTML:{__html:s}})})})]})})};export{m as M,h as S,z as T,y as t};
